...
const slideConfig = { type: "section", index: 14, title: "模块三 · 小型工具管理台账" };
...
function createSlide(pres, theme) {
  ...
  slide.addText("模块三", { x: 0.9, y: 1.7, w: 4, h: 0.6, fontSize: 22, fontFace: "Microsoft YaHei", color: theme.light, bold: true, align: "left" });
  slide.addText("小型工具管理台账", { x: 0.9, y: 2.25, w: 8.2, h: 1.0, fontSize: 44, fontFace: "Microsoft YaHei", color: "FFFFFF", bold: true, align: "left" });
  slide.addShape(pres.shapes.RECTANGLE, { x: 0.92, y: 3.35, w: 3.2, h: 0.06, fill: { color: theme.accent }, line: { type: "none" } });
  slide.addText("给每件工具建一张「身份证」：编号、照片、位置、状态一目了然，还能打印二维码标签。", { x: 0.9, y: 3.6, w: 8.2, h: 0.5, fontSize: 15, fontFace: "Microsoft YaHei", color: "D9DEE6", align: "left" });
